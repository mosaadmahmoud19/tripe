...
class RecommendedPlace extends StatelessWidget {
  final  id;
  const RecommendedPlace({Key? key, required this.id}) : super(key: key);
  @override
                ...
                body: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: ClipRRect(
                            ...
                            child: Stack(children: [
                              Image.network(
                                // model.image ?? 'https://img.freepik.com/free-vector/flat-egypt-travel-round-greeting-card-with-colorful-traditional-egyptian-symbols-elements-isolated-illustration_1284-52394.jpg?size=626&ext=jpg&ga=GA1.2.55020483.1681863343&semt=ais',
                          ...
                          itemBuilder: (context, index) {
                            return  Container(
                              ...
                              child: ClipRRect(
                                  ...
                                  child: Image.network(
                                    //model.images?[index] ?? 'https://img.freepik.com/free-vector/flat-egypt-travel-round-greeting-card-with-colorful-traditional-egyptian-symbols-elements-isolated-illustration_1284-52394.jpg?size=626&ext=jpg&ga=GA1.2.55020483.1681863343&semt=ais',
                      ...
                      SizedBox(
                        height: 350,
                        child: TriperAppCubit.get(context).placeData.data?.plans?.isEmpty ?? true
                            ? Center(
                          ...
                          itemBuilder: (context, index) {
                            try{
                              final nearestPlan = TriperAppCubit.get(context).placeData.data?.plans?.elementAt(index);
                              return nearestPlan != null
                                  ? Container(
                              ...
                              return Image.network('https://img.freepik.com/free-vector/flat-egypt-travel-round-greeting-card-with-colorful-traditional-egyptian-symbols-elements-isolated-illustration_1284-52394.jpg?size=626&ext=jpg&ga=GA1.2.55020483.1681863343&semt=ais');
                            }
                            // Placeholder for null elements
                          },
