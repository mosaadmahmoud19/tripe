...
class HomeTripDetailsPlanScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => GetPlaceCubit()..getPlace(),
      child:BlocConsumer<GetPlaceCubit,GetPlaceStates>(
            ...
            body: Padding(
              ...
              child: SingleChildScrollView(
                ...
                child: ListView.separated(
                  ...
                  {
                    final imageData = GetPlaceCubit.get(context).getPlaceModel.data?.image?.elementAt(index);
                    return imageData != null ? buildTripDetailsPlan(imageData, context) : SizedBox.shrink();
                  },
                  separatorBuilder:(context,index) => Container(
                    height: 10.0,
                  ),
                  itemCount: GetPlaceCubit.get(context).getPlaceModel.data?.image?.length ?? 0,
                ),
              ),
            ),
